...
import type { Board, BoardWithLists, List, Subtask, Task, TaskWithSubtasks } from '@/types';
...
export const subtasksApi = {
  create: (params: { taskId: string; title: string }) => invoke<Subtask>('create_subtask', params),
  toggle: (id: string) => invoke<boolean>('toggle_subtask', { id }),
  delete: (id: string) => invoke<void>('delete_subtask', { id }),
};
