...
import { Play, Pause, Square, Timer as TimerIcon, History, BarChart3, Volume2, VolumeX, CheckCircle } from 'lucide-react';
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      >
        <div className="text-center py-4">
          ...
          <p className="text-lg font-semibold mb-1">{t('pomodoro.completed')}！</p>
          <p className="text-sm text-text-muted">
            {t('pomodoro.title')} {formatHM(mode === 'countdown' ? durationMin * 60 : elapsed)}
          </p>
          {soundPlaying && (
