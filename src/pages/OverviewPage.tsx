    ...
    <div className="p-6 max-w-7xl mx-auto space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
        ...
        <StatCard
          ...
          detail={`${copy.onTimeRate} ${formatPercent(analysis.onTimeRate)} · ${comparisonText(analysis.completedTasks, analysis.previousCompletedTasks)}`}
        />
        <StatCard
